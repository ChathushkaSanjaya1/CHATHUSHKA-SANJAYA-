...
* **Web Development:** HTML5, CSS3, Bootstrap 5, Laravel, Razor, Tailwind CSS 
* **Databases:** MySQL, Microsoft SQL Server
* **QA & Testing:** Black Box/White Box Methodologies, Test Case Design, Unit Testing 
* **Tools:** Git, Visual Studio, Agile (Scrum) 

## 📂 Featured Projects
* **Lanka TravelMate:** A smart travel assistant chatbot developed using Python, Flask, and Bootstrap.
* **DreamDay:** A comprehensive wedding planner web application built with ASP.NET MVC and C#.
...
## 📫 Connect with Me
* **Email:** [chathushkasanjaya018@gmail.com](mailto:chathushkasanjaya018@gmail.com) 
* **Mobile:** +94 76 291 1676 
* **Location:** Kurunegala, Sri Lanka

---
*“Striving for excellence in every task and excited to contribute to forward-thinking organizations.”* 
